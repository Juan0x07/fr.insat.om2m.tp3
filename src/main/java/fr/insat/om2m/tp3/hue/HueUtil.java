...
public class HueUtil {
	...
	public static void connectToBridge() {
	   ...
	   accessPoint.setIpAddress("192.168.0.135");
	   accessPoint.setUsername(HueProperties.getUsername());
	...
	public static void updateDevice(String deviceId, Integer hueValue, Integer bri, Integer sat, Boolean on) {
		...
		PHBridgeResourcesCache cachel = bridge.getResourceCache();
		bridge.updateLightState(cachel.getAllLights().get(0), lightState);
	}
